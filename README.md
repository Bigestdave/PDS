...
## 8. Interactive Web Presentation & Sister Project

* **Interactive Strategy Explorer**: Located in `/pds-01-section` (React 19 + Tailwind CSS v4) with an interactive **$100,000 Portfolio Capital & Risk Simulator**. Run with:
  ```bash
  cd pds-01-section
  npm install
  npm run dev
  ```
* **Sister Project (Track 3: AI Trading Desk)**: [REOPEN Risk Desk](https://github.com/Bigestdave/Reopen) — An institutional-grade, human-in-the-loop AI risk and execution desk.
